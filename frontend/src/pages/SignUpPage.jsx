      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Join Orango</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-2">Experience smart conversations</p>
          </div>
